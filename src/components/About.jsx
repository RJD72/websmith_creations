...
const About = () => {
  return (
    // About
    <div
      className="w-full lg:h-screen h-full m-auto flex items-center justify-center py-20"
      id="about"
    >
      <div className="w-full h-full flex flex-col justify-center items-center sm:px-4 px-2">
        ...
        <div className="lg:w-[80%] w-full mx-auto flex flex-col lg:gap-6 lg:flex-row items-center justify-center ">
          ...
          <div className="lg:w-[60%] p-4 w-full h-full shadow-xl shadow-base/40 flex flex-col justify-center items-center sm:px-6 px-4 rounded-xl">
            <h2 className="text-4xl text-center px-4 py-1 md:mt-0 mt-10">
              A Passionate Web Developer
            </h2>

            <p className=" mt-6 sm:px-2 text-lg">
              Hi, I'm Rob — a passionate web developer and mobile app developer
              with a love for building ideas into reality. While I currently
              work in the construction industry, I'm working toward
              transitioning full-time into the world of development, where I can
              bring digital visions to life. <br />
              <br /> My journey into tech started early. As a kid, I owned a
              keyboard that connected to a TV, where I would spend hours typing
              out code from computer magazines and saving it onto cassette
              tapes. That early spark of creativity and problem-solving never
              left me — it just evolved into creating websites and apps. <br />
              <br />
              ...
              <br /> What drives me most is the satisfaction of seeing the final
              product — the moment when an idea transforms into something real,
              functional, and impactful. Outside of coding, I enjoy playing
              guitar, working out, and finding new adventures to embark on.{" "}
              <br />
              <br /> I'm currently focused on continually growing my skills and
              building a freelance business that blends web and mobile
              development. I'm excited to see where this journey leads — and I'm
