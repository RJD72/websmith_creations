    ...
    <div className="flex flex-col overflow-hidden">
      ...
      >
        <img
          src={Avatar}
          alt="hero"
          className="rounded-2xl object-cover h-48 object-left-top float-left mr-4 mb-4"
          draggable={false}
        />
        <div className="">
          ...
          <p>
            ...
            from my uncle’s magazines and saving it onto cassette tapes. That
            early spark of creativity and problem-solving never left me — it
            just evolved into creating websites and apps.{" "}
          </p>
          <br />
          <p>
            {" "}
